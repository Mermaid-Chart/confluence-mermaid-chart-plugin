...
const App = () => {
  ...
  const createNewDiagram = () => {
    ...
    return (
      <ModalDialog
        header="Select Project and Name of new diagram"
  ...
  const selectProjectAndName = () => {
    ...
    return (
      <ModalDialog
        header="Select Mermaid Chart Diagram"
        onClose={() => setOpen(false)}
      >
        <Form
          onSubmit={(data) => {
  ...
  return (
    <Fragment>
      <Text>
        <Link
          openNewTab
          href={`https://www.mermaidchart.com/app/diagrams/${diagramDocumentID}?ref=vscode`}
        >
          Edit diagram
        </Link>
      </Text>
